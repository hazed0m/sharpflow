    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="rounded-3xl border border-slate-200/20 bg-white/95 px-6 py-5 text-sm text-slate-600 shadow-xl shadow-slate-900/10 dark:border-white/10 dark:bg-slate-900/80 dark:text-slate-200 dark:shadow-black/20">
            Loading SharpFlow...
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-md rounded-[2rem] border border-slate-200/20 bg-white/95 p-8 shadow-glow ring-1 ring-slate-200/30 dark:border-white/10 dark:bg-slate-900/90">
          ...
          <div className="mt-8 space-y-4">
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full rounded-2xl bg-gradient-to-r from-amber-400 to-orange-500 px-4 py-3 text-sm font-semibold text-white transition hover:brightness-110 shadow-lg shadow-amber-500/20"
              >
                Send magic link
              </button>
            </form>
